# import libraries
import dataset, time, math, random
...
batch_size = 32 # Experimented with bs of 16, 20, 32 

# 10 classes of gestures which can be used for various operations. 
classes = ['Gesture_0','Gesture_1','Gesture_2','Gesture_3','Gesture_4','Gesture_5','Gesture_6','Gesture_7','Gesture_8','Gesture_9']
num_classes = len(classes) # 10 classes

# 20% of the data will automatically be used for validation
validation_size = 0.2
img_size = 50 # input image dimension
num_channels = 3 
train_path='E:/Semesters/SEM 5/HCI/HCI Project/Code implementation/Code_implemented/HCI/Traindata'
...
session = tf.Session() # create a new tensorflow session
...
# 7 convolutional layers are used in the filter
filter_size_conv1 = 2 
...
fc_layer_size = 1024 # final fully connected layer
...
def create_convolutional_layer(input,
    ...
    #max-pooling. 
    # can experiemtn with average max pooling layer  
...
def create_flatten_layer(layer):
    layer_shape = layer.get_shape() # previous layer output is used to get the shape of this layer. 
    # format: [batch_size img_size img_size num_channels]

    ## Number of features = img_height * img_width* num_channels
    num_features = layer_shape[1:4].num_elements()

    # Reshaping for the final Flatten layer
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples/batch_size) == 0: 
            ...
            saver.save(session, 'E:/Semesters/SEM 5/HCI/HCI Project/Code implementation/Code_implemented/HCI/handgest_1') 
